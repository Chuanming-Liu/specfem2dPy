...
#         - Plot depth slice.
#         ==============================================================================================
    def plot_depth_slice(self, component, depth, valmin, valmax,
            prefix='mywavefield', iteration=0, verbose=True, stations=True, res="i", mapflag='regional_ortho'):
        """
        ...
        # im = m.pcolor(topodat,cm.gist_earth)
        m.drawcoastlines()
    ...
    def MakeAnimation(self, component, depth, valmin, valmax, outdir, prefix='mywavefield',\
            iter0=100, iterf=17100, dsnap=100, stations=False, res="i", mapflag='regional', dpi=300):
