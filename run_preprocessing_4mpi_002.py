...
SLst.WriteStaList('/lustre/janus_scratch/life9360/specfem2d_working_dir/multipathing_2000km_4000km/DATA/STATIONS')

### Velocity Model
datadir = '/lustre/janus_scratch/life9360/specfem2d_working_dir/multipathing_2000km_4000km/DATA/model'
outdir ='/lustre/janus_scratch/life9360/specfem2d_working_dir/multipathing_2000km_4000km/DATA'
# 
...
for iproc in xrange(nproc):
    ...
    Vm.CircleCosineAnomaly( Xc=1000000, Zc=1000000, R=100000, dv = -0.2)
