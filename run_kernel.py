...
kfield.readASDF(infname='/lustre/janus_scratch/life9360/specfem2d_working_dir/LFMembrane_SH_healing_005_adj/kernel_amp.h5')
...
# plt.plot(Zarr/1000, kfield.value, '-',lw=3,  markersize=10, label='1500')
# 
# kfield.get_value(x=2500000)
# plt.plot(Zarr/1000, kfield.value, '-',lw=3,  markersize=10, label='2500')
# 
