...
dbase.GetField(outdir='./D_990km', fieldtype='amp', data_type='DISPpmf2')
dbase.GetField(outdir='./D_990km', fieldtype='Vgr',  data_type='DISPpmf2')
dbase.GetField(outdir='./D_990km', fieldtype='Vph',  data_type='DISPpmf2')
