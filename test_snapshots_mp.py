...
WS=field2d_cartesian.WaveSnapshot_mp(xmin=0, xmax=4000000, Nx=800, zmin=0, zmax=2000000, Nz=400, datadir=
        '/lustre/janus_scratch/life9360/specfem2d_working_dir/LFMembrane_SH_healing_002/OUTPUT_FILES', dn=50, nt=30000, nproc=12)
# WS.ReadGridFile()
# WS.GetElementIndex()
# WS.SaveElementIndex('/lustre/janus_scratch/life9360/specfem2d_working_dir/LFMembrane_SH_healing_002/OUTPUT_FILES')
WS.LoadElementIndex('/lustre/janus_scratch/life9360/specfem2d_working_dir/LFMembrane_SH_healing_002/OUTPUT_FILES')
