...
SLst.ReadStaList('/projects/life9360/code/SEM/specfem2d/EXAMPLES/LFMembrane_acoustic/DATA/STATIONS');
SDB=symData2d.Specfem2dDataBase( enx=240000., enz=240000., StaLst=SLst);
datadir='/projects/life9360/code/SEM/specfem2d/EXAMPLES/LFMembrane_acoustic/OUTPUT_FILES'
SDB.ReadtxtSeismograms(datadir=datadir, sfx='.BXZ.semd');
outdir='/lustre/janus_scratch/life9360/specfem2d_data_acoustic/SAC_homo'
SDB.SaveSeismograms(outdir);
# 
# # SDB.ReadSeismograms(datadir='/lustre/janus_scratch/life9360/specfem2d_data/SAC_homo')
# 
outdir='/lustre/janus_scratch/life9360/specfem2d_data_acoustic/aftan_homo';
...
SDB.GetField2dFile(datadir='/lustre/janus_scratch/life9360/specfem2d_data_acoustic/aftan_homo',
                        outdir='/lustre/janus_scratch/life9360/specfem2d_data_acoustic/field_homo', perLst=[10. ], outfmt='txt')

### Field Analysis
# dx=3.
# dy=3.
# myfield=field2d.Field2d(Nx=480/dx, Ny=480/dx, dx=dx, dy=dy);
# myfield.LoadFile('/lustre/janus_scratch/life9360/specfem2d_data_acoustic/field_homo/TravelT.ph.10.0.txt')
...
# myfield2.LoadFile('/lustre/janus_scratch/life9360/specfem2d_data_acoustic/field_homo/TravelT.ph.10.0.txt')
# myfield2.natgridInterp();
# myfield2.PlotField()
# myfield2.Gradient(method='default');
