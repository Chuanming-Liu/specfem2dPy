...
# nStream=obspy.Stream();
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.30S30..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.35S35..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.40S40..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.45S45..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.50S50..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.55S55..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.60S60..SAC')[0])
# SpecStream.append(obspy.read('/lustre/janus_scratch/life9360/specfem2d_data_001/SAC_homo/MEM2D.65S65..SAC')[0])
...
for trace in SpecStream:
    # print trace.stats.sac.dist*1000.
    trace.stats.distance=trace.stats.sac.dist*1000.
    # nStream.append(trace)
SpecStream.plot(type='section',  norm_method='stream', alpha=1.0, linewidth = 2.5, recordlength=150.)
# 
# VgrArr=np.array([]);
# AmpArr=np.array([]);
# DistArr=np.array([]);
