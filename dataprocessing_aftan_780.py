...
dbase=symdata.specfem2dASDF('/lustre/janus_scratch/life9360/specfem2d_working_dir/LFMembrane_SH_D_780/specfem2d_780.h5')
...
dbase.GetField(outdir='./D_780km', fieldtype='amp', data_type='DISPpmf2')
dbase.GetField(outdir='./D_780km', fieldtype='Vgr',  data_type='DISPpmf2')
dbase.GetField(outdir='./D_780km', fieldtype='Vph',  data_type='DISPpmf2')
